...
%  \cleardoublepage
  ...
  \chapter{Analyse der Swing
  Applikationen}\label{chapter:AnalyseDerSwingApplikationen}
  
  \input{./kapitel/analyseDerSwingApplikationen.tex}
  ...
  \chapter{Analyse der Web
  Frameworks}\label{chapter:AnalyseDerWebFrameworks}
  
  \input{./kapitel/analyseDerWebFrameworks.tex} 
