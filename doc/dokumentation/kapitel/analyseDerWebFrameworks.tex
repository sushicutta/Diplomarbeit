  ...
  die Methode der gewichteten \ac{NWA}\cite{Nutzwertanalyse} gewählt.
  ...
  einzelnen Faktoren zu erhalten wurde die Methode \ac{AHP} gewählt. Diese
  Methode stammt aus dem Bereich der präskriptiven Entscheidungstheorie. Der
  \ac{AHP} wurde von Thomas L. Saaty in den 70er Jahren des 20.
  Jahrhunderts entwickelt und im Buch ``The Analytic Hierarchy Process:
