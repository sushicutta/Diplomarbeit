  ...
  \begin{itemize}
    ...
    \item bereits eingesetzte Frameworks
  \end{itemize}
  ...
  MVC - Framework, das in der ZKB bis jetzt eingesetzt wird.
  
  \subsubsection{A-3 - Vaadin 6.5.7}
  
  Vaadin zählt zu den Cross-Compiler Frameworks und baut auf \ac{GWT} auf.
  
  \subsubsection{A-4 - Apache Wicket 1.4.17}
  
  Bestehendes Framework, das in der ZKB bis jetzt eingesetzt wird. An dieser
  Stelle ist zu erwähnen, dass der Einsatz aufgrund von Ausnahmegenehmigungen
  eingesetzt werden darf. Diese müssten im Falle einer erfolgreichen Evaluation
  ...
  KO-Kriteiren nicht beachtet werden. In Absprache mit dem Fachbetreuer der
  \ac{ZKB} wurden folgende KO-Kriterien im Rahmen der Diplomarbeit als
  unzulässlich befunden:
  ...
  \subsection{A-2 - Struts 1.3 mit ZIP - Framework}
