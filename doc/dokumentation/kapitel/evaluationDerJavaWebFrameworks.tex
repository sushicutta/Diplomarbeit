  ...
  \subsubsection{Alternative C}
  
  \subsubsection{Alternative D}  
  ...
  Die Bestimmung der Gewichte wird über die Methode des \ac{AHP} gemacht. Dabei
  werden alle ``wichtigen'' Soll-Kriterien miteinander verglichen. Die
  Vergleichsmatrix ist in der Tabelle \ref{tab:gewichtungDerSollKriterien}
  ersichtlich.
