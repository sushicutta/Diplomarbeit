  ...
  MVC - Framework, das in der \ac{ZKB} bereits eingesetzt wird. Das Framework
  wird innerhalb der \ac{ZKB} für die Umsetzung der Online Bank verwendet und
  gilt als Standard für neue Projekte. Um einen Vergleich mit diesem Framework
  zu haben, soll es ebenfalls in die Evaluation miteinbezogen werden.
